...
<body>
    <div class="container-fluid bg">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <h1 style="color: #e74423;margin-top: 15vh;text-align: center;">WELCOME TO HMS</h1>
                <div class="login-form  form-container">
                    ...
                    <form method="post" action="admin.php">
                        ...
                        <button class="login-btn" type="submit" name="login_admin">Login</button>
                        <a href="login.php"><button type="button"class="login-btn"style="margin-top:10px;" >Back</button></a>
