        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="#"><i class="fa fa-sitemap"></i> Admin<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="Add-Admin.php">Add Admin</a>
                            </li>
                            <li>
                                <a class="active-menu" href="view-admin.php">View All Admin</a>
                            </li>
                        </ul>
                    </li>
                    <li>
...
<h1 class="heading1" style="padding-bottom:20px;">View All Admin</h1>
            <button id="displaydata" class="button"style="margin-bottom:30px;">View All Admin</button>
