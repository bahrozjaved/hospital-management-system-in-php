        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="view-prescription.php"><i class="fa fa-sitemap"></i> View Prescription</a>
...
<h1 class="heading1" style="padding-bottom:20px;">View All Prescription</h1>
            <button id="displaydata" class="button"style="margin-bottom:30px;">View All Prescription</button>
