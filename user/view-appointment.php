        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="add-appointment.php"class="active-menu"><i class="fa fa-sitemap"></i> Appointment<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href='add-appointment.php'>Add Appointment</a>
                            </li>
                            <li>
                                <a class="active-menu"href="view-appointment.php">View All Appointment</a>
                            </li>
                        </ul>
                    </li>
