            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="add-account.php"class="active-menu">Add Accountant</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            <div class="header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Add Accountant</li>
                </ol>
            ...
            <div class="container c1" style="margin-bottom: 120px;">
                ...
                <?php include('errors.php'); ?>  
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="dname"value="<?php echo $username; ?>" placeholder="Enter Accountant Name or username" name="username">
                    </div>
                    ...
                    <button type="submit"name="reg_acc" class="button">Add Accountant</button>
                </form>
            </div>
