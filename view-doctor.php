        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"href="#"><i class="fa fa-sitemap"></i> Doctor<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="Add-doctor.php">Add Doctor</a>
                            </li>
                            <li>
                                <a class="active-menu"href="view-doctor.php">View All Doctor</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            <div class="header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">View All Doctor</li>
                </ol>

            </div>
        <div class="container text-center">
<h1 class="heading1" style="padding-bottom:20px;">View All Doctor</h1>
            <button id="displaydata" class="button"style="margin-bottom:30px;">View All Doctor</button>
