        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"href="#"><i class="fa fa-sitemap"></i>Pharmacy<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu"href="add-pharmacy.php">Register Pharmacy employee</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            <div class="header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Add pharmacy</li>
                </ol>
            ...
            <div class="container c1" style="margin-bottom: 120px;">
                <form action="add-pharmacy.php"method="post">
                <?php include('errors.php'); ?>  
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="dname"value="<?php echo $username; ?>" placeholder="Enter pharmacy Name or username" name="username">
                    </div>
                    ...
                    <button type="submit"name="reg_pharmacy" class="button">Add Doctor</button>
                </form>
            </div>
