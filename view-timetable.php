...
{  
     ...
     {  
          $output .= '<option value="'.$row["depart_name"].'">'.$row["depart_name"].'</option>';  
     }  
     return $output;  
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="view-timetable.php"class="active-menu">view Schedule </a>
            ...
            <div class="container c1" style="margin-bottom: 120px;">
                <?php include('errors.php'); ?>  
                    <div class="form-group text-center heading1">
                        <h1>View Complete Schedule</h1>
                    </div>
                       
                            <div class="form-group">
                                <label for="sel1">Select Department:</label>
                                <select class="form-control"name="brand" id="brand">  
                          <option value="">Show All depart</option>  
