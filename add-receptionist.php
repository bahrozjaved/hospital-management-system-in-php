        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"class="active-menu"><i class="fa fa-sitemap"></i>Receptionist<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="add-receptionist.php"class="active-menu">Add reception member</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            <div class="header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Add Receptionist member</li>
                </ol>
            ...
            <div class="container c1" style="margin-bottom: 120px;">
                <form action="add-receptionist.php"method="post">
                <?php include('errors.php'); ?>  
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="dname"value="<?php echo $username; ?>" placeholder="Enter receptionist Name or username" name="username">
                    </div>
                    ...
                    <button type="submit"name="reg_rec" class="button">Add Receptionist</button>
                </form>
            </div>
