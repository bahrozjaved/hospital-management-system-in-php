                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-menu"href="view-nurse.php">View All Nurse</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper">
            <div class="header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">View All Nurse</li>
                </ol>

            </div>
        <div class="container text-center">
<h1 class="heading1" style="padding-bottom:20px;">View All Nurse</h1>
            <button id="displaydata" class="button"style="margin-bottom:30px;">View All Nurse</button>
