        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"class="active-menu"><i class="fa fa-sitemap"></i>Account<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="add-account.php">Add Accountant</a>
                            </li>
                            <li>
                                <a class="active-menu" href="view-account.php">View Accountant</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper">
            <div class="header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">View All Accountant</li>
                </ol>

            </div>
        <div class="container text-center">
<h1 class="heading1" style="padding-bottom:20px;">View All Accountant</h1>
            <button id="displaydata" class="button"style="margin-bottom:30px;">View All Accountant</button>
