                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-menu"href="view-pharmacy.php">View Pharmacy details</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="view-reception.php"class="active-menu">View all member</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper">
            <div class="header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">View All receptionist</li>
                </ol>

            </div>
        <div class="container text-center">
<h1 class="heading1" style="padding-bottom:20px;">View All receptionist</h1>
            <button id="displaydata" class="button"style="margin-bottom:30px;">View All receptionist</button>
