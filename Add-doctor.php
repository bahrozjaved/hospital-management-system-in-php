            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu"href="Add-doctor.php">Add Doctor</a>
                            </li>
                            <li>
            ...
            <div class="container c1" style="margin-bottom: 120px;">
                ...
                <?php include('errors.php'); ?>  
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="dname"value="<?php echo $username; ?>" placeholder="Enter Doctor Name" name="username">
                    </div>
                    ...
                    <button type="submit"name="reg_doctor" class="button">Add Doctor</button>
                </form>
            </div>
